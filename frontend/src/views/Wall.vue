    ...
    <div class="tw-p-4 tw-max-w-6xl tw-m-auto tw-h-full">
      ...
      <template v-for="(category, i) in Object.keys(categories)">
        <PaintDripSection :key="i" :color="categories[category].color">
          <div class="tw-text-4xl tw-font-semibold tw-mb-4 tw-text-white">
            {{ category }}
          </div>
          <div class="tw-space-y-4">
            ...
            >
              ...
              <div class="tw-w-96 tw-p-4">
                <div
                  class="tw-text-white tw-text-lg tw-font-semibold tw-tracking-wide"
                >
                  {{ stickers[stickerId].name }}
                </div>
                <div class="tw-text-gray-300">
                  {{ stickers[stickerId].description }}
                </div>
              </div>
            </div>
          </div>
  ...
  data: () => ({
    ...
    stickers: {
      ...
      abcd: {
        ...
        description:
          'I went to UPenn as part of the M&T program, majoring in CS & Finance',
        category: 'Professional',
      },
      ncie: {
      ...
      idk: {
        ...
        description:
          'I designed my own map in Team Fortress 2 and gained widespread community adoption',
        category: 'Fun',
      },
      noice: {
        ...
        description:
          'I won 1st place at the Supernova Hackathon, in the SocialFi category',
